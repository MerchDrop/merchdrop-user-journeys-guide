...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-card hover:shadow-hero",
        destructive:
        ...
        hero: "bg-hero-gradient text-primary-foreground hover:scale-105 shadow-hero hover:shadow-glow font-semibold",
        accent: "bg-accent-gradient text-accent-foreground hover:bg-accent-light shadow-card hover:shadow-hero",
        creator: "bg-purple-gradient text-primary-foreground hover:scale-105 shadow-card hover:shadow-glow",
